...
export declare class Slot {
	...
	static is(slot: any): boolean;
}

export declare function slot(): Slot;

declare interface EachProps {
	array: Signal<any[]>;
	children: (value: any, index: number, array: any[]) => SugiliteNode;
	wrapper?: string | Component | JQuery;
}

export declare function Each(props: EachProps): SugiliteNode;

declare interface PatienceProps {
	children: SugiliteNode[];
	fallback: SugiliteNode | undefined;
}

export declare function Patience(props: PatienceProps): SugiliteNode;

declare interface CaseProps {
	children: SugiliteNode[];
	predicate: Signal<boolean>;
}

export declare function Case(props: CaseProps): SugiliteNode;
